...
- Module Collaborateurs fonctionnel : équipe, contacts, couleur planning, prestations attribuées, jours travaillés, horaires et pauses.
...
3. Exécuter dans l’ordre :
   ...
   - `supabase/migrations/003_staff_availability.sql`
...
Cette V1.3.0 ajoute la gestion réelle des collaborateurs et de leurs disponibilités hebdomadaires. Les chiffres affichés sur les tableaux de bord restent encore des données visuelles de démonstration. Le prochain lot prévu est le planning des rendez-vous, puis la réservation publique client.
