...
Cette V1.0 pose le socle officiel de NCR Suite avec son identité visuelle définitive. Les chiffres affichés sur les tableaux de bord sont des données visuelles de démonstration. Les modules métier détaillés seront développés lot par lot.
