...
const allowedAnonFunctions = new Set([
  ...
  'public_booking_client_portal_activation_status','request_public_booking_client_portal_activation','register_public_booking_referral','tag_public_beauty_booking_origin'
]);
