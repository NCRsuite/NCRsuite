...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v284.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v284.css');
...
const output = [
  '/* NCR Suite V2.28.4 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.28.4 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
