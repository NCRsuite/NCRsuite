...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v232.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v232.css');
...
const output = [
  '/* NCR Suite V2.23.2 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.23.2 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
