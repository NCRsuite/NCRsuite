...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v296.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v296.css');
...
const output = [
  '/* NCR Suite V2.29.6 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.29.6 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
