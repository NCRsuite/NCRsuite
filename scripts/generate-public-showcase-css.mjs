...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v2917.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v2917.css');
...
const output = [
  '/* NCR Suite V2.29.17 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.29.17 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
