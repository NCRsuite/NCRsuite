...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v241.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v241.css');
...
const output = [
  '/* NCR Suite V2.24.1 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.24.1 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
