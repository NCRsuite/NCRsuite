...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v262.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v262.css');
...
const output = [
  '/* NCR Suite V2.26.2 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.26.2 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
