...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v293.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v293.css');
...
const output = [
  '/* NCR Suite V2.29.3 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.29.3 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
