...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v286.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v286.css');
...
const output = [
  '/* NCR Suite V2.28.6 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.28.6 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
