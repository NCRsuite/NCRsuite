...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v240.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v240.css');
...
const output = [
  '/* NCR Suite V2.24.0 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.24.0 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
