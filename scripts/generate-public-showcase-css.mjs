...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v231.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v231.css');
...
const output = [
  '/* NCR Suite V2.23.1 - styles critiques de la vitrine signature */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.23.1 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
