...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v261.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v261.css');
...
const output = [
  '/* NCR Suite V2.26.1 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.26.1 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
