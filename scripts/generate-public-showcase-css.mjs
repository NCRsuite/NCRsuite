...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v230.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v230.css');
...
const output = [
  '/* NCR Suite V2.23.0 - styles critiques de la vitrine premium */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.23.0 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
