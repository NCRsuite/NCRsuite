...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v2921.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v2921.css');
...
const output = [
  '/* NCR Suite V2.29.21 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.29.21 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
