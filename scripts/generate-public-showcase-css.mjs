...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v2910.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v2910.css');
...
const output = [
  '/* NCR Suite V2.29.10 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.29.10 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
