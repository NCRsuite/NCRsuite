...
const showcaseOutputPath = path.join(root, 'public', 'ncr-suite-showcase-v299.css');
const appOutputPath = path.join(root, 'public', 'ncr-suite-app-v299.css');
...
const output = [
  '/* NCR Suite V2.29.9 - styles critiques de la vitrine */',
...
fs.writeFileSync(appOutputPath, [
  '/* NCR Suite V2.29.9 - styles complets servis hors du dossier assets */',
  source,
  ''
].join('\n'), 'utf8');
