...
export const BUSINESS_ROUTE_PATHS: Record<BusinessType, Set<string>> = {
  coiffure: new Set([
    ...common(),
    '/rendez-vous', '/clients', '/crm', '/comptabilite', '/imports', '/donnees-rgpd', '/equipe', '/acces-equipe', '/prestations', '/ressources', '/stocks', '/pilotage', '/historique', '/fidelite', '/personnalisation'
  ]),
  formation: new Set([
    ...common(),
    '/parcours-formation', '/profil-organisme', '/formations', '/stagiaires', '/formateurs', '/sessions', '/mon-activite', '/mon-planning', '/facturation-mensuelle', '/commercial', '/facturation-formation', '/bpf', '/qualite-formation', '/portails-formation', '/dossiers-formation', '/documents', '/emargements', '/evaluations', '/attestations', '/etablissements', '/acces-equipe', '/personnalisation'
  ]),
  securite: new Set([
    ...common(),
  ...
  nettoyage: new Set([
    ...common(),
    '/terrain', '/planning', '/clients', '/portail-clients', '/sites', '/agents', '/interventions', '/protocoles', '/rapports', '/anomalies', '/qualite', '/stocks', '/rentabilite', '/facturation', '/acces-equipe'
  ]),
...
const MANAGER_PATHS: Partial<Record<BusinessType, Set<string>>> = {
  ...
  nettoyage: new Set(['/', '/terrain', '/planning', '/portail-clients', '/agents', '/sites', '/interventions', '/protocoles', '/rapports', '/anomalies', '/qualite', '/stocks', '/notifications', '/assistance', '/parametres', '/demarrage']),
