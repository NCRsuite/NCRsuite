...
export const businessPacks: Record<BusinessType, BusinessPack> = {
  ...
  restauration: {
    ...
    navigation: [
      { label: 'Tableau de bord', path: '/', icon: 'home' },
      { label: 'Espace employés', path: '/terrain', icon: 'utensils' },
      ...
      { label: 'Fiches recettes', path: '/recettes', icon: 'clipboard' },
    ...
    quickActions: [
      ...
      { label: 'Créer une recette', path: '/recettes', icon: 'clipboard' },
