...
export interface SecurityShiftRecord {
  ...
  clocked_in_source?: 'agent' | 'qg' | 'migration' | null;
  clocked_out_at?: string | null;
  clocked_out_by?: string | null;
  clocked_out_source?: 'agent' | 'qg' | 'migration' | null;
  logbook_status?: 'open' | 'closed';
  logbook_closed_at?: string | null;
  logbook_closed_by?: string | null;
  logbook_closed_source?: 'agent' | 'qg' | 'dossier' | 'migration' | null;
  billing_minutes_override?: number | null;
